...
func _process(delta: float) -> void:
	...
	if active:
		...
		$MeshInstance3D/Sprite3D.modulate=lerp($MeshInstance3D/Sprite3D.modulate,Color(1.0, 1.0, 1.0, 1.0),lerpspeed*delta*1.5)
		$MeshInstance3D/Sprite3D2.modulate=lerp($MeshInstance3D/Sprite3D2.modulate,Color(1.0, 1.0, 1.0, 1.0),lerpspeed*delta*1.5)
		...
		$MeshInstance3D/Sprite3D.modulate=lerp($MeshInstance3D/Sprite3D.modulate,Color(0.0, 0.0, 0.0, 1.0),lerpspeed*delta*1.5)
